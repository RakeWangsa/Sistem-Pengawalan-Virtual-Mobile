...
class _MyHomePageState2 extends State<MyHomePage2> {
  ...
  final LatLng.LatLng defaultInitialCenter =
      LatLng.LatLng(-6.213332697186609, 106.82594181574434);
  LatLng.LatLng initialCenter =
      LatLng.LatLng(0, 0); // Inisialisasi initialCenter dengan nilai default
  ...
  void initState() {
    ...
    initialCenter = LatLng.LatLng(
        widget.lat, widget.lng); // Mengatur nilai initialCenter saat initState
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => DokumentasiPetugas()),
                      );
                    },
                  ),
                  Divider(),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LaporanPengawalan()),
                      );
                    },
                  ),
                  Divider(),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RiwayatPengawalan()),
                      );
                    },
                  ),
                  Divider(),
                  ...
                  markers: snapshot.data!.docs.map<Marker>((doc) {
                    ...
                    return Marker(
                      point: LatLng.LatLng(
                        ...
                        double.parse(
                            data['LatLong'].split(',')[1]), // Longitude
                      ),
                      child: Stack(
                    ...
                    ..addAll(snapshot.data!.docs.map<Marker>((doc) {
                      ...
                      return Marker(
                        point: LatLng.LatLng(
                          double.parse(
                              data['LatLongIKI'].split(',')[0]), // Latitude
                          double.parse(
                              data['LatLongIKI'].split(',')[1]), // Longitude
                        ),
                        child: Stack(
                          alignment: Alignment.center,
                          children: [
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              ...
                              child: StreamBuilder<QuerySnapshot>(
                                stream: FirebaseFirestore.instance
                                    .collection('Pengawalan')
                                    .orderBy('No Pengajuan')
                                    .snapshots(),
                                builder: (context, snapshot) {
                                                                  ...
                                                                  showDialog(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      content:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                              'No Pengajuan: ${data['No Pengajuan']}'),
                                                                          Text(
                                                                              'Tujuan: ${data['Tujuan']}'),
