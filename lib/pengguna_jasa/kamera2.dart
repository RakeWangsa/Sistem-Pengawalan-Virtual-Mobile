    ...
    if (mounted) {
      ...
      if (file != null) {
        if (imageFile != null) {
          ...
          Reference storageReference = FirebaseStorage.instance.ref().child('images/${DateTime.now()}.txt');
...
uploadTask.whenComplete(() {
  showInSnackBar('Picture saved to Firebase Storage');
}).catchError((error) {
  showInSnackBar('Failed to upload picture: $error');
});

// const String putStringText =
//         'Rakev';

// return storageReference.putString(
//       putStringText,
